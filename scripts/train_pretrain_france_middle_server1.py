...
def parse_args():
    ...
    # runtime
    p.add_argument("--output_dir", type=str, default="../MandelbrotV1/outputs_incremental_pretraining_middle1", help="Output directory for checkpoints")
    ...
    # p.add_argument("--resume_from_checkpoint", type=str, default="../MandelbrotV1/outputs_incremental_pretraining_middle1/checkpoint-180900", help="Path to a checkpoint to resume training from (overrides --model_name_or_path)")
