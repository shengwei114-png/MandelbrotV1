...
p.add_argument("--model_root", default="/root/autodl-tmp/MandelbrotV1/configs/middle2")
p.add_argument("--checkpoint_dir", default="/root/autodl-tmp/MandelbrotV1/outputs_incremental_pretraining_middle2/checkpoint-epoch-0")
