...
p.add_argument("--model_root", default="../MandelbrotV1/configs/middle1")
p.add_argument("--checkpoint_dir", default="../MandelbrotV1/outputs_incremental_pretraining_middle1/checkpoint-epoch-0")
