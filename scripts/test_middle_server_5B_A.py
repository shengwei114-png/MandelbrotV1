...
p.add_argument("--model_root", default="/root/autodl-tmp/MandelbrotV1/configs/middle1")
p.add_argument("--checkpoint_dir", default="/root/autodl-tmp/MandelbrotV1/outputs_incremental_pretraining_middle1/checkpoint-epoch-0")
...
model = MandelbrotV1ForCausalLM(
    config=config, start_block_idx=20, end_block_idx=22,
