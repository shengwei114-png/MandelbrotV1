...
def parse_args():
    ...
    # runtime
    p.add_argument("--output_dir", type=str, default="../MandelbrotV1/outputs_incremental_pretraining_middle2", help="Output directory for checkpoints")
    ...
    # p.add_argument("--resume_from_checkpoint", type=str, default="../MandelbrotV1/outputs_incremental_pretraining_middle2/checkpoint-180900", help="Path to a checkpoint to resume training from (overrides --model_name_or_path)")
    ...
    p.add_argument("--distribution_Type", type=str, default="middle_Server", choices=["server", "client","middle_Server","local","incremental_pretrain_full","incremental_pretrain"], help="分布式训练类型(is_Distribution=True有效)：server,middle_Server,client 本地训练类型(is_Distribution=False有效)：local,incremental_pretrain_full,incremental_pretrain")
